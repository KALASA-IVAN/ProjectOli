!(function () {
  ...
  (e = window),
    (t = function () {
      ...
      function j(e, t, n, r, o, l, c) {
        var u = e.evaluateReturnExpression(t, r, o);
        if ('value' === n) {
          if (
            be.ignoreFocusedForValueBinding &&
      ...
      function se(e, t, n) {
        Q.call(G(n), H(n)).forEach((i) => {
          let r = K(n, i);
          r.configurable || (r = he(e, r, re)), q(t, i, r);
        }),
          V(t);
      }
      class oe {
        ...
        getOwnPropertyDescriptor(e, t) {
          ...
          const o = K(e, t);
          return Y(o)
            ? ((s = he(i, s, re)), s.configurable || q(e, t, s), s)
            : o;
        }
        preventExtensions(e) {
          const { originalTarget: t, membrane: n } = this;
          return se(n, e, t), V(t), !0;
        }
        defineProperty(e, t, n) {
          const { originalTarget: i, membrane: r } = this,
            { valueMutated: s } = r,
            { configurable: o } = n;
          if (Z.call(n, 'writable') && !Z.call(n, 'value')) {
            const e = K(i, t);
            n.value = e.value;
          }
          return (
            q(
              ...
              t,
              (function (e) {
                return Z.call(e, 'value') && (e.value = ie(e.value)), e;
              })(n)
            ),
            !1 === o && q(e, t, he(r, n, re)),
            s(i, t),
      ...
      class le {
        ...
        getOwnPropertyDescriptor(e, t) {
          ...
          return Y(o)
            ? ((s = he(i, s, ae)),
              Z.call(s, 'set') && (s.set = void 0),
              s.configurable || q(e, t, s),
              s)
            : o;
        }
        preventExtensions(e) {
      ...
      function ce(e) {
        let t;
        return I(e) ? (t = []) : 'object' == typeof e && (t = {}), t;
      }
      ...
      class ve {
        constructor(e) {
          if (
            ((this.valueDistortion = pe),
            (this.valueMutated = me),
            ...
            (this.valueDistortion = ee(t) ? t : pe),
              (this.valueMutated = ee(n) ? n : me),
              (this.valueObserved = ee(i) ? i : fe),
          ...
          return (
            (i = {
              get reactive() {
                const n = new oe(r, t),
                  i = new Proxy(ce(t), n);
                return ne(i, e), q(this, 'reactive', { value: i }), i;
              },
              get readOnly() {
                const n = new le(r, t),
                  i = new Proxy(ce(t), n);
                return ne(i, e), q(this, 'readOnly', { value: i }), i;
              },
            }),
            n.set(t, i),
            i
      ...
      class ye {
        constructor(e, t = null) {
          ...
          let s = { $el: this.$el },
            o = t ? t.$el : this.$el;
          Object.entries(be.magicProperties).forEach(([e, t]) => {
          ...
          (this.$data = l),
            ...
            t || be.onBeforeComponentInitializeds.forEach((e) => e(this)),
            r &&
              !t &&
            ...
            t ||
              setTimeout(() => {
                be.onComponentInitializeds.forEach((e) => e(this));
              }, 0);
        }
        getUnobservedData() {
          return (function (e, t) {
                ...
                case 'model':
                  !(function (e, t, i, r, s) {
                    ...
                    L(
                      ...
                      () =>
                        n(n({}, s()), {}, { rightSideOfExpression: R(t, i, r) })
                    );
                  })(this, e, s, o, t);
              }
            }
